...
<head>
    ...
    <title>DiabetCare AI - Hasta Girişi</title>
...
<style>
    * {
    ...
    .floating-element:nth-child(1) { top: 20%; left: 10%; animation-delay: 0s; color: rgba(0, 212, 255, 0.08); }
    ...
    .regform::before {
        ...
        right: 0;
        bottom: 0;
        background: linear-gradient(135deg, rgba(0, 212, 255, 0.1) 0%, transparent 50%, rgba(255, 107, 107, 0.1) 100%);
        opacity: 0.5;
        pointer-events: none;
    }
    ...
    .input input::placeholder, .password input::placeholder {
        color: rgba(255, 255, 255, 0.6);
    }

    .input input:focus, .password input:focus {
        border-color: #00d4ff;
...
<body>
    <div class="floating-elements">
        ...
        <div class="floating-element"><i class="fas fa-user"></i></div>
        <div class="floating-element"><i class="fas fa-chart-line"></i></div>
        <div class="floating-element"><i class="fas fa-notes-medical"></i></div>
    </div>
        ...
        <div class="regform">
            <form action="" method="post">
                <p class="logo">
                    ...
                    Diabet<b style="color:#00d4ff;">Care AI</b>
                </p>
                <p id="heading">
                ...
                <div class="input">
                    <input type="email" placeholder="E-Posta Adresinizi Giriniz" name="email" value="" required />
                </div>
                ...
                <div class="signin-up">
                    <p id="signin-up">Hesap Oluşturmak İçin <a href="signup.php">Kayıt Ol</a></p>
                </div>
            </form>
        </div>
    </div>
